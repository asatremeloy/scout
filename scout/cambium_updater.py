...
class UsefulInputFiles(object):
    ...
    def __init__(self):
        ...
        self.emm_midcase = (
            fp.CONVERT_DATA / "emm_region_emissions_prices-MidCase.json"
        )
        self.emm_95by2050 = (
            fp.CONVERT_DATA / "emm_region_emissions_prices-95by2050.json"
        )
        self.emm_100by2035 = (
            fp.CONVERT_DATA / "emm_region_emissions_prices-100by2035.json"
        )
        # Set the path to the State CO2 emissions intensities
        # and price data for all Cambium scenarios
        self.state_midcase = (
            fp.CONVERT_DATA / "state_emissions_prices-MidCase.json"
        )
        self.state_95by2050 = (
            fp.CONVERT_DATA / "state_emissions_prices-95by2050.json"
        )
        self.state_100by2035 = (
            fp.CONVERT_DATA / "state_emissions_prices-100by2035.json"
        )
        # Set the path to the hourly EMM Region emissions/price scaling factors
        # for all Cambium scenarios
        self.tsv_cost_emm_midcase = (
            fp.TSV_DATA / "tsv_cost-emm-MidCase.gz"
        )
        self.tsv_carbon_emm_midcase = (
            fp.TSV_DATA / "tsv_carbon-emm-MidCase.gz"
        )
        self.tsv_cost_emm_95by2050 = (
            fp.TSV_DATA / "tsv_cost-emm-95by2050.gz"
        )
        self.tsv_carbon_emm_95by2050 = (
            fp.TSV_DATA / "tsv_carbon-emm-95by2050.gz"
        )
        self.tsv_cost_emm_100by2035 = (
            fp.TSV_DATA / "tsv_cost-emm-100by2035.gz"
        )
        self.tsv_carbon_emm_100by2035 = (
            fp.TSV_DATA / "tsv_carbon-emm-100by2035.gz"
        )
        # Set the path to the hourly State emissions/price scaling factors
        # for all Cambium scenarios
        self.tsv_cost_state_midcase = (
            fp.TSV_DATA / "tsv_cost-state-MidCase.gz"
        )
        self.tsv_carbon_state_midcase = (
            fp.TSV_DATA / "tsv_carbon-state-MidCase.gz"
        )
        self.tsv_cost_state_95by2050 = (
            fp.TSV_DATA / "tsv_cost-state-95by2050.gz"
        )
        self.tsv_carbon_state_95by2050 = (
            fp.TSV_DATA / "tsv_carbon-state-95by2050.gz"
        )
        self.tsv_cost_state_100by2035 = (
            fp.TSV_DATA / "tsv_cost-state-100by2035.gz"
        )
        self.tsv_carbon_state_100by2035 = (
            fp.TSV_DATA / "tsv_carbon-state-100by2035.gz"
        )
...
def main():
    ...
    if full_update == 'Yes':
        ...
        hourly_cost_json_emm = hourly_factors_updater(df_hour_emm, scenario,
                                                      year,
                                                      metric='cost',
                                                      geography='EMM')
        hourly_carbon_json_emm = hourly_factors_updater(df_hour_emm, scenario,
                                                        year,
                                                        metric='carbon',
                                                        geography='EMM')
